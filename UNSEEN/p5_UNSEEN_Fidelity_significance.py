...
p_values_ds =  xr.open_mfdataset(f'/gpfs/work2/0/einf2224/paper3/model_runs/SEAS5_statistics/independence_tests/{model_folder}/fidelity/pvalues_era5_allyear/*_permboots.nc')
...
significant_mean = benjamini_hochberg(p_values_mean, alpha=0.1)        # alpha = 0.05x2 for FDR
...
output_directory_sign=f'../../model_runs/SEAS5_statistics/independence_tests/{model_folder}/fidelity/significance_era5_allyear/'
output_file_sign = os.path.join(output_directory_sign, f'SEAS5_fidelity_sign_permboots.nc')
